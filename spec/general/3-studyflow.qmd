...
For a complete list of supported elements and their attributes, see the [Studyflow ontology](https://github.com/behaverse/studyflow-modeler/blob/main/docs/ontologies/bdm_studyflow.yaml).
