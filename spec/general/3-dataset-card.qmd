...
Dataset card
: A structured representation of metadata. It is generally defined in the `README.md` front matter of a dataset (see [folder structure](2-folder-structure.qmd)) and provides information about its creator, license, funding, and other relevant information.
