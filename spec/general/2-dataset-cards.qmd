...
Dataset card
: A structured metadata about the dataset. It is generally defined in the frontmatter part of `README.md` file (see [folder structure](1-folder-structure.qmd)) and provides information about its creator, license, and other relevant information.
