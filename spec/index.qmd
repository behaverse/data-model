...
: Summary, scores, or models that are derived from trials (or raw events). Derived models are generally used to address research questions and can be further used for downstream summarization, analysis, deployment, or reporting.
