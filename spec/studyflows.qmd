...
`studyflow_log.csv`
: What actually happened for one agent, at the root of that agent's folder (`data/agent_001/studyflow_log.csv`). One file per agent, because each agent traverses the design differently.
