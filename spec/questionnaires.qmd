...
subtitle: When information presented to subjects is a "question"
aliases:
  - /spec/general/questionnaires.html
---

::: {.callout-note appearance="simple"}
See also [Questionnaire data guide](../guides/4-questionnaire-data.qmd) for practical examples and recommendations about questionnaire data.
:::
...
This is the design that we have adopted in the Behaverse Data Model.
...
- In questionnaires, people rarely use the term stimulus. Instead they use the term "question" or "item" (although the latter term is somewhat ambiguous).
