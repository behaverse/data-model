...
![Main use cases for the BDM, from the start of a research project to its completion.](/assets/bpmn/bdm_use_cases.png)
...
- Agent
- Task (task-specific events-to-trials mapping)
- Experimental Design (e.g., adaptive parameters, conditions, etc)
