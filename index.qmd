...
- [Concepts](/concepts/index.qmd): Detailed explanations of fundamental concepts and design decisions.
...
To suggest improvements, please read the [design process](concepts/design-process.qmd) and visit [discussions on GitHub](https://github.com/orgs/behaverse/discussions). Everyone is welcome to [contribute](contribute.qmd).
