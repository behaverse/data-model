...
The *Behaverse Data Model (BDM)* is an ongoing attempt to define a data format for cognitive datasets that unifies a wide range of cognitive tasks and questionnaires. It aims to establish conventions for structuring datasets and their content.
