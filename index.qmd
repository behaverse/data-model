...
The *Behaverse Data Model (BDM)* defines a coherent data model for behavioral data which unifies a wide range of cognitive tests and questionnaires. It also establishes guidelines for structuring behavioral datasets and naming behavioral variables.
