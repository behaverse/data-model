...
StudyFlows are visual, but formal, diagrams based on BPMN that describe cognitive studies. StudyFlows can be used to describe the study protocol, the analysis pipeline, or any other steps in a study. They can be used to communicate with the participants (automatically running a study) and the researchers (reproducible protocols and analyses).
