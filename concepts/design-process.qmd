...
Events are often recorded as soon as they occur in a transactional way, meaning that they are resulted from an interaction between the task and the agent. This data structure is more convenient for the software than storing complex data structures (like trials), as most code is written to control user interactions and store the corresponding data.
...
Here is a diagram of the trial. The diagram shows the relationships between the domain-specific concepts and their attributes.
