...
├─ study/<br> 
│ ├─ study_design.json<br> 
│ ├─ instructions.json<br> 
│ ├─ instruments.csv<br> 
│ ├─ ...<br> 
...
Additional folders are included within each subjects' folder depending on the specific activities completed by that subject. For example, if the subject completed the bisbas questionnaire and the Stroop test there would be two correspding data folders (i.e., `bisbas`, `stroop_test`).
...
The optional vignette folder may contain sample code, and/or data analyses (typically in notebooks) to showcase some aspects of the data (e.g., descriptive statistics, missing values).
