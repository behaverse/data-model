...
The study/ folder contains information about the study. This includes in particular 
 - **instruments.csv**: describes the instruments used for the data collection. 
