...
:::{.table-responsive}
|trial_id   |agent_id |session_index|stimulus_id|stimulus_index|stimulus_description           |stimulus_onset|stimulus_duration|option_id  |option_onset|option_duration|response_description|response_numeric|response_option_index|response_time|accuracy                   |correct                    |score|
|-----------|---------|-------------|-----------|--------------|-------------------------------|--------------|-----------------|-----------|------------|---------------|--------------------|----------------|---------------------|-------------|---------------------------|---------------------------|-----|
|1          |agent_1  |1            |stimulus_1 |1             |Do you like ice cream?         |0             |5                |yes_no     |0           |5              |yes                 |1               |1                    |2            |[*NA*]{.text-muted .small} |[*NA*]{.text-muted .small} |1    |
|2          |agent_1  |1            |stimulus_2 |2             |How much do you like ice cream?|0             |5                |agreement_5|0           |5              |strongly agree      |4               |5                    |5            |[*NA*]{.text-muted .small} |[*NA*]{.text-muted .small} |4    |
