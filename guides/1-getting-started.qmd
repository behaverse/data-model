...
See the [*<i class="bi bi-grid-3x3"></i> Response* table](/spec/trial/1-response.qmd) for more information. Trials are stored in the `response_<ATTEMPT>.csv` file within the activity folder and can be accompanied by the optional supporting tables for stimuli, options, etc.
