...
Behaverse Data Model (BDM for short) is a dataset architecture that aims to provide a interoperable data for modern cognitive projects. It is a set of conventions and tools that help you organize your data in a way that is easy to understand and use for both domain experts and technical experts. It is designed to be easy to use, and to work with a wide range of data types.
