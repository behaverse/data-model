...
The `beh/` folder is named after the data types in it (i.e., behavioral data). If your dataset includes additional data types, you can create corresponding folders. For example, you could create a `egg/` folder to store the EEG data files or a `func/` folder to store the fMRI data files. See [BIDS data types](https://bids.neuroimaging.io/getting_started/folders_and_files/folders.html#datatype) for a list of supported data types and corresponding folder names.
:::