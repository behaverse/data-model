---
title: "<i class='bi bi-reception-1 float-end'></i> Getting Started"
...
See the [*<i class="bi bi-grid-3x3"></i> Trial* table](/reference/trials/trial.qmd) for more information.
