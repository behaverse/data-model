...
The `README.md` file contains both human-readable description and machine-readable metadata of the dataset. The `beh/` folder contain the behavioral data files. Each data file in this folder is a CSV table where each column is a variable about the data. The `instruments/` folder contains the tasks, questionnaires, and corresponding parameters. Each instrument is a YAML file that describes the instrument and its parameters.
