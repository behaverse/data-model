...
The L1-data contains multiple tables, some of which are detailed in this document, others will be added in the future. We use square brackets to refer to specific tables (e.g., the Trial table or the Stimulus table) and we use quotes (“”) to indicate the semantic category that groups various columns in a table; these semantic categories are used here only to highlight the ordering of the columns within each table.
## [Trial]
### “Key”
#### id [integer]
...
*Note*: we currently don’t use session_name, session_id and session_repetition in this table.
### “Task”
...
*Note:* other expectations and task constraints may be added in the future (e.g., based on max response time).
