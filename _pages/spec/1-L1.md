...
trial_start_date_time [date_time]
...
Table describing a part of a stimulus.

### Key

stimulus_id [integer]
: A reference to the primary key of the Stimulus table.
...
symbol [string]
: The name of the symbol displayed.
