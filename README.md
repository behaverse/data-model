...
*Behaverse Data Model (BDM)* is an ongoing effort to define coherent data structure for cognitive tests and questionnaires that can be applied to a large range of use cases. It also defines concepts and recommends best practices for behavioral datasets. Visit [behaverse.org/data-model](https://behaverse.org/data-model) for more information.
